...
param = "Duration of Mechanical Ventilation";
image_prefix = 'figure_duration_mech_vent_adj';
...
% CENSOR
% this should be ok in detecting the right time interval for censorship
is_censored = ~ismember(raw_table.vent_episode_outcome_was_extubated, 'true');
time_interval = cell_of_strings_to_numerical_array(raw_table.ve_time_on_vent_not_trached) ./ 24;
...
ylabel(['Fraction of patients ' outcome_description], 'fontsize',14);
axis([0 21 0 1])
grid off
